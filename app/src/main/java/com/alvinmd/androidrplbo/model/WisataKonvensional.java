...
public class WisataKonvensional {
    ...
    public WisataKonvensional() {
    }

    public WisataKonvensional(String nama_wisata, String deskripsi_wisata, String thumb_wisata, String navigasi_wisata, String notelp_wisata, String email_wisata, String alamat_wisata, String id, String non_aktif) {
